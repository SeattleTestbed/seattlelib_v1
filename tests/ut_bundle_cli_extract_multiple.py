"""
Test the extracting of multiple files in a bundle through the command line.
"""
...
bundle_test_helper.run_program("bundler.py", ["extract", TEST_BUNDLE_FN] + TEST_COPY_FILENAMES)
